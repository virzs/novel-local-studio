...
function ToolFallbackRoot({
  ...
  return (
    <Collapsible
      ...
      className={cn(
        "aui-tool-fallback-root group/tool-fallback-root my-2 w-full rounded-lg border py-3",
        className,
      )}
      style={
        {
...
const ToolFallbackImpl: ToolCallMessagePartComponent = ({
  ...
  const displayStatus = getDisplayStatus(status, result, isErrorProp);
  const isCancelled =
    displayStatus.type === "incomplete" && displayStatus.reason === "cancelled";
  const isError =
    displayStatus.type === "incomplete" && displayStatus.reason === "error";
